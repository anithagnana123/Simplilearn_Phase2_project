...
public class DeleteSubServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h2>Delete a subject</h2>");
		out.println("<table>");
		out.println("<tr>");
		out.println("<td>Enter the subject ID</td>");
		out.println("<td> <input type='text' name='sub_id'> </td>");
		out.println("</tr>");
		out.println("</table>");
		out.println("<br> <br> <input type='submit' value='submit'/>");
		out.println("<input type='hidden' name='operation' value='deletesubject'/>");
	    out.println("</form>");
